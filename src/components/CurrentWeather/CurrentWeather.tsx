  ...
  return (
    <div className="p-5 bg-[#D9D9D9] w-[50rem] h-[20rem] rounded-3xl shadow-[8px_8px_2px_1px_rgba(41,41,41,0.6)] flex flex-row justify-between items-center">
      <section className="p-5">
        ...
        <SunriseSunset image={<SunriseIcon Width={"50"} Height={"50"} />} sunPosition={'Sunrise'} time={'06:45 AM'} />
        <SunriseSunset image={<SunsetIcon Width={"50"} Height={"50"} />} sunPosition={'Sunset'} time={'17:45 PM'}/>
      </section>
      ...
      <section className="w-[14rem] flex items-center flex-wrap">
        <WeatherFeatures image={<HumidityIcon Width={"50"} Height={"50"} />} condition={'48%'} atmoFactors={'Humidity'}/>
        <WeatherFeatures image={<WindSpeedIcon Width={"50"} Height={"50"} />} condition={'2km/h'} atmoFactors={'Wind Speed'}/>
        <WeatherFeatures image={<PressureIcon Width={"50"} Height={"50"} />} condition={'997hpa'} atmoFactors={'Pressure'}/>
        <WeatherFeatures image={<UVIcon Width={"50"} Height={"50"} />} condition={'8'} atmoFactors={'UV'}/>       
      </section>
    </div>
  );
}
